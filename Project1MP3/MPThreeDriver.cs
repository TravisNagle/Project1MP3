...
public class MPThreeDriver
{
    ...
    public static Playlist RemoveSong(string username, Playlist playlist)
    {
        ...
        playlist.GetPlaylist().RemoveAt(userChoice - 1);
        Console.WriteLine($"Song {userChoice} has been removed");
    ...
    public static void SearchName(string username, Playlist playlist)
    {
        ...
        Console.WriteLine();
        for (int i = 0; i < playlist.GetPlaylist().Count; i++)
        {
            if (playlist.GetPlaylist()[i].SongTitle == searchedSongName)
            {
                searchedPlaylist.Add(playlist.GetPlaylist()[i]);
            }
            else if(playlist.GetPlaylist()[i].SongTitle != searchedSongName && i == playlist.GetPlaylist().Count - 1)
            {
    ...
    public static void SearchGenre(string username, Playlist playlist)
    {
        ...
        for (int i = 0; i < playlist.GetPlaylist().Count; i++)
        {
            if (playlist.GetPlaylist()[i].Genre == userGenre)
            {
                searchedPlaylist.Add(playlist.GetPlaylist()[i]);
            }
            else if (playlist.GetPlaylist()[i].Genre != userGenre && i == playlist.GetPlaylist().Count - 1)
            {
    ...
    public static void SearchArtist(string username, Playlist playlist)
    {
        ...
        for (int i = 0; i < playlist.GetPlaylist().Count; i++)
        {
            if (playlist.GetPlaylist()[i].Artist == searchedArtistName)
            {
                searchedPlaylist.Add(playlist.GetPlaylist()[i]);
            }
            else if (playlist.GetPlaylist()[i].Artist != searchedArtistName && i == playlist.GetPlaylist().Count - 1)
            {
